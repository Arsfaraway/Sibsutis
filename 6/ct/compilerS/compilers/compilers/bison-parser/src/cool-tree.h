...
// file: cool-tree.h
//
// Этот файл определяет классы для каждого типа и конструктор
//
//////////////////////////////////////////////////////////
...
// определяем класс для типа
// определяем простую программу для типа
...
// определение простого типа - признака
...
// определить простой тип - формальный
...
// определение простого выражения типа
...
// определение простого типа - Case
...
// определяем класс для phylum - СПИСКА
// // определяем список phylum - классов
...
// определить конструктор - назначить
